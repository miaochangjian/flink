...
/**
 * A {@code StateRegistry} will be deployed in the 
 * {@link org.apache.flink.runtime.checkpoint.CompletedCheckpointStore} to 
 * maintain the reference count of the {@link StateObject}s.
 */
public class StateRegistry {

	/** All registered state objects */
	private final Map<StateObject, Integer> registeredStates = new HashMap<>();
