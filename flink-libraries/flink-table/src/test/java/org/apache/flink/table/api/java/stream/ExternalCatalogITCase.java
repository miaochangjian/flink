...
public class ExternalCatalogITCase {
	...
	public void testSQL() throws Exception {
		...
		tableEnv.registerExternalCatalog("test", CommonTestData.getMockedFlinkExternalCatalog());
	...
	public void testTableAPI() throws Exception {
		...
		Table table1 = tableEnv.scan("test", new TableIdentifier("db1", "tb1"));
		Table table2 = tableEnv.scan("test", new TableIdentifier("db2", "tb2"));
