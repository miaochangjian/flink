...
class ExternalCatalogITCase(
  ...
  def testSQL(): Unit = {
    ...
    tEnv.registerExternalCatalog("test", CommonTestData.getMockedFlinkExternalCatalog)
  ...
  def testTableAPI(): Unit = {
    ...
    tEnv.registerExternalCatalog("test", CommonTestData.getMockedFlinkExternalCatalog)
    val table1 = tEnv.scan("test", new TableIdentifier("db1", "tb1"))
    val table2 = tEnv.scan("test", new TableIdentifier("db2", "tb2"))
